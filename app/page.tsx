        ...
        >
          ...
          <div className="flex flex-col bg-[#76c481] bg-opacity-10 rounded-2xl p-4 border border-[#76c481] border-opacity-20">
            ...
            <motion.h2
              layout
              layoutId="name"
              className="text-2xl font-logo mt-3"
            >
              iPhone 15 Pro
            </motion.h2>
            <motion.h3 layout layoutId="price" className="font-logo mt-1">
              $1,499.00 USDC
            </motion.h3>
      ...
      {step === "payment" && (
        ...
        >
          ...
          <div className="flex flex-col bg-[#76c481] bg-opacity-10 rounded-2xl p-4 border border-[#76c481] border-opacity-20">
            ...
            <button className="w-full bg-[#5b9763] hover:bg-opacity-80 active:bg-opacity-90 rounded-lg mt-3 p-3 text-white flex items-center justify-center gap-2">
              Pay $1,000
            </button>
          </div>
        </motion.div>
